...
const MuiLayout = () => {
  return (
    ...
    <Grid container my={4} rowSpacing={2} columnSpacing={1}>
        ...
        <Grid item xs={9}><Box bgcolor="secondary.light" p={2}>Item 2</Box></Grid>
        <Grid item xs={6}><Box bgcolor="error.light" p={2}>Item 3</Box></Grid>
        <Grid item xs={6}><Box bgcolor="success.light" p={2}>Item 4</Box></Grid>
    </Grid>
    </Paper>
